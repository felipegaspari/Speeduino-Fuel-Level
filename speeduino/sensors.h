...
bool fuelLevelHasRun = false;
byte fuelLevelCounter;
volatile float tempFuelLevel;
volatile float tempFuelLevelAveraged;
volatile float tempFuelLevelFloat;
volatile float tempFuelLevelMapped;
float mathMin;
float mathMax;
uint16_t mathCapacity;
